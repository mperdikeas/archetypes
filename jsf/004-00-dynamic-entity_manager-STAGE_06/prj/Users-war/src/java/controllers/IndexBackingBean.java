...
public class IndexBackingBean implements Serializable {
    ...
    @EJB(mappedName = "java:global/Common-ejb/Common-ejb/userFacade!facades.IUserFacadeRemote")
    ...
    private IUserFacadeRemote getUserFacade_via_JNDI() {
        String jndiName = "java:global/Common-ejb/Common-ejb/userFacade!facades.IUserFacadeRemote";
        try {
