...
// Inclusive
public class BeforeComponent implements IIsComponent, IJPQLQueryComponent {
    Logger l = Logger.getLogger(BeforeComponent.class.getName());
    private Date value;

    public BeforeComponent(Date value) {
        this.value = value;
    }
