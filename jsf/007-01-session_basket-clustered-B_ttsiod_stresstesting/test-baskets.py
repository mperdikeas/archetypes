...
def listOfRandomWords():
    ...
    return ["".join(random.choice(ascii_uppercase) for x in xrange(15)) for i in xrange(500)]
...
def StartJBoss(newBossIndex):
    ...
    g_jbosses[newBossIndex] = \
        subprocess.Popen("./launch-node" + str(newBossIndex+1)+"-exec", shell=True, executable="/bin/bash")
