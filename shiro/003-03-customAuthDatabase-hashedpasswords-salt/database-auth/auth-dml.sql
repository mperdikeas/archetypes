...
INSERT INTO "SS_USERS"("SUBS_ID", "USER_NAME", "USER_PASSWORD", "USER_PASSWORD_SALT", "USER_FIRSTNAME", "USER_SURNAME") (SELECT max("SUBS_ID"), 'bill' , 'a603d7fea04d4ae942b9828c41c0f19761d8868a50046c53664a7b69bf357286' , 'foo', 'Bill' , 'Gates'    FROM "SS_SUBSCRIPTIONS");
INSERT INTO "SS_USERS"("SUBS_ID", "USER_NAME", "USER_PASSWORD", "USER_PASSWORD_SALT", "USER_FIRSTNAME", "USER_SURNAME") (SELECT max("SUBS_ID"), 'james', 'd50ffcd0b397b3ddf3814b9256c8f3149ee5517d85b13bc9c967217a828483c0' , 'foo', 'James', 'Stewart'  FROM "SS_SUBSCRIPTIONS");
INSERT INTO "SS_USERS"("SUBS_ID", "USER_NAME", "USER_PASSWORD", "USER_PASSWORD_SALT", "USER_FIRSTNAME", "USER_SURNAME") (SELECT max("SUBS_ID"), 'mary' , '553277b52de90ca45ed8a689a24019ba1eb31bee9555806c0cb8a1cc06c4feb5' , 'foo', 'Mary' , 'Bones'    FROM "SS_SUBSCRIPTIONS");
INSERT INTO "SS_USERS"("SUBS_ID", "USER_NAME", "USER_PASSWORD", "USER_PASSWORD_SALT", "USER_FIRSTNAME", "USER_SURNAME") (SELECT max("SUBS_ID"), 'jack' , '256179882f18c58616eeb27e28d04ccb31ccc6bb44a1a977a314415201682a2f' , 'foo', 'Jack' , 'Paranoid' FROM "SS_SUBSCRIPTIONS");
