...
\begin{figure}[htbp]
    ...
    \caption{The Black Knight - big figure that requires A3}
...
\KOMAoptions{paper=a3,paper=landscape} %requires \usepackage{typearea} in the preamble (http://tex.stackexchange.com/q/179714/52217)
\recalctypearea
